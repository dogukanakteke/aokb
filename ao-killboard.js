/*
* @Author: Dogukan AKTEKE
* @Date:   2017-09-03 04:42:56
* @Last Modified by:   Dogukan AKTEKE
* @Last Modified time: 2017-09-03 11:46:51
*/
...
client.on('ready', () => {
    ...
    client.user.setPresence({ game: { name: 'By @Hex#9851', type: 0 } }); // broken due to discord API changes
